...
/**
   ...
   */
    ...
    arm_status convolve_s8_kernel3_stride2(const q7_t *input,
                               const uint16_t input_x,
                               const uint16_t input_y,
                               const uint16_t input_ch,
                               const uint16_t input_batches,
    ...
    arm_status convolve_s8_kernel3_stride2_pad1(const q7_t *input,
                               const uint16_t input_x,
                               const uint16_t input_y,
                               const uint16_t input_ch,
                               const uint16_t input_batches,
    ...
    arm_status mix_convolve_s8_kernel3_inputch3_stride2_pad1(const q7_t *input,
                               const uint16_t input_x,
                               const uint16_t input_y,
                               const uint16_t input_ch,
                               const uint16_t input_batches,
    ...
    arm_status convolve_s8_kernel3_stride2_pad1_naive(const q7_t *input,
                               const uint16_t input_x,
                               const uint16_t input_y,
                               const uint16_t input_ch,
                               const uint16_t input_batches,
     ...
     * Group Convolution
     * */
    arm_status arm_convolve_s8_group(const q7_t *input,
                               const uint16_t input_x,
                               const uint16_t input_y,
                               const uint16_t input_ch,
                               const uint16_t input_batches,
    ...
    /*
         * Group Convolution
         * */
        arm_status arm_convolve_s8_group_img2col(const q7_t *input,
                                   const uint16_t input_x,
                                   const uint16_t input_y,
                                   const uint16_t input_ch,
                                   const uint16_t input_batches,
   ...
   *
   */
    arm_status convolve_1x1_s8_t(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_inch12_a4w2(const q8_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_inch8_a4w2(const q8_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w2_unroll(const q8_t *input,
                                                const uint16_t input_x,
                                                const uint16_t input_y,
                                                const uint16_t input_ch,
                                                const uint16_t input_batches,
    ...
    arm_status fast_convolve_s8_kernel3_inputch3_stride2_pad1_a4w2 (const q7_t *input,
    		const uint16_t input_x, const uint16_t input_y, const uint16_t input_ch,
    		const uint16_t input_batches, const q7_t *kernel,
    		const uint16_t output_ch, const uint16_t kernel_x,
    		const uint16_t kernel_y, const uint16_t pad_x, const uint16_t pad_y,
    		const uint16_t stride_x, const uint16_t stride_y, const int32_t *bias,
    		q7_t *output, const int32_t *output_shift, const int32_t *output_mult,
    		...
    		q7_t pad_value, float* keans_lut);

    arm_status fast_convolve_1x1_a4w2_noOF(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const uint16_t input_batches,
											...
											const uint16_t output_y,
											uint32_t *buffer_a,
											const int32_t* kmeans_multiplier,
											const q7_t* kmeans_shift);

    arm_status fast_convolve_1x1_a4w2_OF16(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w2_OF20(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w2_OF80(const q7_t *input,
 											const uint16_t input_x,
 											const uint16_t input_y,
 											const uint16_t input_ch,
 											const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w2_OF64(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w2(const q7_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w2_overflow(const q7_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status fast_convolve_1x1_a4w4(const q8_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status mix_convolve_1x1_s8(const q7_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status arm_convolve_1x1_s8_fast_small(const q7_t *input,
                                            const uint16_t input_x,
                                            const uint16_t input_y,
                                            const uint16_t input_ch,
                                            const uint16_t input_batches,
    ...
    arm_status arm_convolve_1x1_s8_fast_large(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const uint16_t input_batches,
    ...
    arm_status arm_convolve_1x1_s8_fast_block(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const uint16_t input_batches,
    ...
    arm_status arm_convolve_1x1_s8_fast_gemm(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const uint16_t input_batches,
    ...
    arm_status arm_convolve_1x1_s8_fast_default(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const uint16_t input_batches,
    ...
    arm_status arm_convolve_1x1_s8_fast_group_img2col(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const uint16_t input_batches,
...
/**
  ...
  arm_status depthwise_conv_s8_kernel_stationary(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel3(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel3_stride1(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status mix_depthwise_conv_s8_kernel3_stride1_pad1(const q7_t *input,
                                          const uint16_t input_x,
                                          const uint16_t input_y,
                                          const uint16_t input_ch,
                                          const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel3_stride1_pad1(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel3_stride1_dynamic(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status mix_depthwise_conv_s8_kernel3_stride2_pad1(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel3_stride2_pad1(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel3_stride2(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel5(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel5_stride1(const q7_t *input,
										  const uint16_t input_x,
										  const uint16_t input_y,
										  const uint16_t input_ch,
										  const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel5_stride2(const q7_t *input,
										  const uint16_t input_x,
										  const uint16_t input_y,
										  const uint16_t input_ch,
										  const q7_t *kernel,
  ...
  arm_status fast_depthwise_conv_s8_kernel5_stride1_pad1_a4w8(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const q7_t *kernel,
  ...
  arm_status fast_depthwise_conv_s8_kernel5_stride1_pad2_a8w8_8bit(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const q7_t *kernel,
  ...
  arm_status fast_depthwise_conv_s8_kernel5_stride1_pad2_a4w8_8bit(const q7_t *input,
											const uint16_t input_x,
											const uint16_t input_y,
											const uint16_t input_ch,
											const q7_t *kernel,
  ...
  arm_status mix_depthwise_conv_s8_kernel5_stride1_pad2(const q7_t *input,
                                          const uint16_t input_x,
                                          const uint16_t input_y,
                                          const uint16_t input_ch,
                                          const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel5_stride1_pad2(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status mix_depthwise_conv_s8_kernel5_stride2_pad2(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel5_stride2_pad2(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel5_stride1_dynamic(const q7_t *input,
										  const uint16_t input_x,
										  const uint16_t input_y,
										  const uint16_t input_ch,
										  const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel7(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel7_stride1(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status mix_depthwise_conv_s8_kernel7_stride1_pad3(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel7_stride1_pad3(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel7_stride2(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status mix_depthwise_conv_s8_kernel7_stride2_pad3(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel7_stride2_pad3(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status depthwise_conv_s8_kernel7_stride2_pad3_naive(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
  ...
  arm_status arm_depthwise_conv_s8_opt_channel_reorder_stationary(const q7_t *input,
                                         const uint16_t input_x,
                                         const uint16_t input_y,
                                         const uint16_t input_ch,
                                         const q7_t *kernel,
  ...
  arm_status arm_depthwise_conv_s16_s8_opt(const q15_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
 ...
 */
   ...
   */
    ...
    q7_t *arm_nn_mat_mult_kernel_s8_s16_4col(const q7_t *input_a,
                                        const q15_t *input_b,
                                        const uint16_t output_ch,
                                        const int32_t *out_shift,
                                        const int32_t *out_mult,
    ...
    q7_t *arm_nn_mat_mult_kernel_s8_s16_group(const q7_t *input_a,
                                        const q15_t *input_b,
                                        const uint16_t output_ch,
                                        const int32_t *out_shift,
                                        const int32_t *out_mult,
    ...
    q7_t *arm_nn_mat_mult_kernel_s8_s16_group_img2col(const q7_t *input_a,
                                        const q15_t *input_b,
                                        const uint16_t output_ch,
                                        const int32_t *out_shift,
                                        const int32_t *out_mult,
   ...
   */
    ...
    q7_t *b42_nn_mat_mult_kernel_s8_s16_reordered(const q7_t *input_a,
                                                      const q15_t *input_b,
                                                      const uint16_t output_ch,
                                                      const int32_t *out_shift,
                                                      const int32_t *out_mult,
	...
	q7_t *b44_nn_mat_mult_kernel_s8_s16_reordered(const q7_t *input_a,
												  const q15_t *input_b,
												  const uint16_t output_ch,
												  const int32_t *out_shift,
												  const int32_t *out_mult,
    ...
    q7_t *b22_nn_mat_mult_kernel_s8_s16_reordered(const q7_t *input_a,
                                                  const q15_t *input_b,
                                                  const uint16_t output_ch,
                                                  const int32_t *out_shift,
                                                  const int32_t *out_mult,
    ...
    q7_t *b24_nn_mat_mult_kernel_s8_s16_reordered(const q7_t *input_a,
                                                  const q15_t *input_b,
                                                  const uint16_t output_ch,
                                                  const int32_t *out_shift,
                                                  const int32_t *out_mult,
                                                  ...
                                                  const int32_t *const output_bias,
                                                  q7_t *out_0);
    q7_t *b28_nn_mat_mult_kernel_s8_s16_reordered(const q7_t *input_a,
                                                     const q15_t *input_b,
                                                     const uint16_t output_ch,
                                                     const int32_t *out_shift,
                                                     const int32_t *out_mult,
       ...
       q7_t *b42_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
   												  const q15_t *input_b,
   												  const uint16_t output_ch,
   												  const int32_t *out_shift,
   												  const int32_t *out_mult,
   	...
   	q7_t *b44_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
   													  const q15_t *input_b,
   													  const uint16_t output_ch,
   													  const int32_t *out_shift,
   													  const int32_t *out_mult,
   	...
   	q7_t *b48_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
   													  const q15_t *input_b,
   													  const uint16_t output_ch,
   													  const int32_t *out_shift,
   													  const int32_t *out_mult,
   ...
   q7_t *b22_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
													 const q15_t *input_b,
													 const uint16_t output_ch,
													 const int32_t *out_shift,
													 const int32_t *out_mult,
   ...
   q7_t *b24_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
													 const q15_t *input_b,
													 const uint16_t output_ch,
													 const int32_t *out_shift,
													 const int32_t *out_mult,
   ...
   q7_t *b28_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
													 const q15_t *input_b,
													 const uint16_t output_ch,
													 const int32_t *out_shift,
													 const int32_t *out_mult,
   ...
   q7_t *arm_nn_mat_mult_kernel_s8_s16_reordered_8mul(const q7_t *input_a,
    ...
    q7_t *arm_nn_mat_mult_kernel_s8_s16_reorderedkbuf(const q7_t *input_a,
                                                      const q15_t *input_b,
                                                      const uint16_t output_ch,
                                                      const int32_t *out_shift,
                                                      const int32_t *out_mult,
    ...
    q7_t *arm_nn_mat_mult_kernel_s8_s16_reorderedkbuf_block(const q7_t *input_a,
                                                      const q15_t *input_b,
                                                      const uint16_t output_ch,
                                                      const int32_t *out_shift,
                                                      const int32_t *out_mult,
	...
	q7_t *arm_nn_mat_mult_kernel_s8_s16_reordered_unrollby8(const q7_t *input_a,
													  const q15_t *input_b,
													  const uint16_t output_ch,
													  const int32_t *out_shift,
													  const int32_t *out_mult,
	...
	q7_t  *arm_nn_mat_mult_kernel_s8_s16_reordered_unrollby12(const q7_t *input_a,
													  const q15_t *input_b,
													  const uint16_t output_ch,
													  const int32_t *out_shift,
													  const int32_t *out_mult,
	...
	q7_t *arm_nn_mat_mult_kernel_s8_s16_reordered_unrollby16(const q7_t *input_a,
													  const q15_t *input_b,
													  const uint16_t output_ch,
													  const int32_t *out_shift,
													  const int32_t *out_mult,
	...
	q7_t *arm_nn_mat_mult_kernel_s8_s16_reordered_unrollby20(const q7_t *input_a,
														  const q15_t *input_b,
														  const uint16_t output_ch,
														  const int32_t *out_shift,
														  const int32_t *out_mult,
	...
	q7_t *arm_nn_mat_mult_kernel_s8_s16_reordered_4col(const q7_t *input_a,
	                                              const q15_t *input_b,
	                                              const uint16_t output_ch,
	                                              const int32_t *out_shift,
	                                              const int32_t *out_mult,
    ...
    q7_t *arm_nn_mat_mult_kernel_s8_s16_reordered_group_img2col(const q7_t *input_a,
                                                  const q15_t *input_b,
                                                  const uint16_t output_ch,
                                                  const int32_t *out_shift,
                                                  const int32_t *out_mult,
